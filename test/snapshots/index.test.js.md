...
> Generated files
    ...
    [
      ...
      'src/plugins/filters.js',
      'src/plugins/icon-font.js',
      'src/plugins/svg-icon/index.js',
      'src/plugins/svg-icon/svg/alipay.svg',
      'src/plugins/svg-icon/svg/book.svg',
      'src/plugins/svg-icon/svg/device.svg',
      'src/plugins/svg-icon/svg/face.svg',
      'src/plugins/svg-icon/svg/finger-print.svg',
      'src/plugins/svg-icon/svg/logo.svg',
      'src/plugins/svg-icon/svg/mail.svg',
      'src/plugins/svg-icon/svg/phone.svg',
      'src/plugins/svg-icon/svg/taobao.svg',
